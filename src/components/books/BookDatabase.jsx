...
export const books = [
  ...
  },
  {
    ...
    // ── Ελληνικά βιβλία (Greek language = 'el') ──────────────────────────────
    // Ενήλικες / Adults
    {
    id: 101,
    title: "Ζορμπάς ο Έλληνας",
    author: "Νίκος Καζαντζάκης",
    isbn: "9789600302516",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789600302516-L.jpg",
    pageCount: 368,
    publishYear: 1946,
    publisher: "Καζαντζάκης",
    language: "el",
    tags: ["sinn_philosophie", "literatur", "persoenliche_entwicklung"],
    difficulty: "fortgeschritten",
    timeEffort: "mittel",
    style: ["story", "reflektierend"],
    description: "Ο αφηγητής γνωρίζει τον Ζορμπά, έναν ελεύθερο πνευματικά άνθρωπο που τον διδάσκει να ζει χωρίς δεσμά. Κλασικό έργο της ελληνικής λογοτεχνίας.",
    coverColor: "bg-amber-100",
    ageGroup: "erwachsene"
    },
    {
    ...
    author: "Νίκος Καζαντζάκης",
    isbn: "9789600302509",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9780671212025-L.jpg",
    pageCount: 368,
    publishYear: 1946,
    publisher: "Καζαντζάκης",
    language: "el",
    tags: ["sinn_philosophie", "literatur"],
    difficulty: "fortgeschritten",
    timeEffort: "mittel",
    style: ["story", "reflektierend"],
    description: "Η αυθεντική έκδοση του κλασικού μυθιστορήματος του Καζαντζάκη.",
    coverColor: "bg-amber-100",
    ageGroup: "erwachsene"
    },
    {
    id: 103,
    title: "Ατομικές Συνήθειες",
    author: "James Clear",
    isbn: "9786180139037",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9786180139037-L.jpg",
    pageCount: 320,
    publishYear: 2019,
    publisher: "Διόπτρα",
    language: "el",
    ...
    timeEffort: "mittel",
    style: ["praktisch", "wissenschaftlich"],
    description: "Ο James Clear δείχνει πώς μικρές αλλαγές 1% στις συνήθειες οδηγούν σε δραματικά αποτελέσματα μέσω του σύνθετου τόκου της συμπεριφοράς.",
    coverColor: "bg-orange-100",
    ageGroup: "erwachsene"
    },
    {
    id: 104,
    title: "Η Δύναμη του Τώρα",
    author: "Eckhart Tolle",
    isbn: "9789604580972",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789604580972-L.jpg",
    pageCount: 256,
    publishYear: 2004,
    publisher: "Πύρινος Κόσμος",
    language: "el",
    tags: ["stress_ruhe", "sinn_philosophie", "persoenliche_entwicklung"],
    difficulty: "einsteiger",
    timeEffort: "mittel",
    style: ["reflektierend", "praktisch"],
    description: "Ο Tolle εξηγεί πώς να απελευθερωθούμε από τον νου μας και να ζούμε πλήρως στο παρόν. Μεταφρασμένο βέστ σέλερ.",
    coverColor: "bg-purple-100",
    ageGroup: "erwachsene"
    },
    {
    id: 105,
    title: "Σάπιενς: Μια Σύντομη Ιστορία της Ανθρωπότητας",
    author: "Yuval Noah Harari",
    isbn: "9786185048037",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9786185048037-L.jpg",
    pageCount: 520,
    publishYear: 2014,
    ...
    timeEffort: "lang",
    style: ["wissenschaftlich", "anspruchsvoll"],
    description: "Η ιστορία του ανθρώπου από την προϊστορία ως σήμερα. Το παγκόσμιο μπέστ σέλερ του Harari στα ελληνικά.",
    coverColor: "bg-blue-100",
    ageGroup: "erwachsene"
    },
    {
    ...
    author: "Paulo Coelho",
    isbn: "9789601408033",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601408033-L.jpg",
    pageCount: 192,
    publishYear: 1998,
    publisher: "Ψυχογιός",
    language: "el",
    ...
    timeEffort: "kurz",
    style: ["story", "reflektierend"],
    description: "Ο Σαντιάγκο ταξιδεύει αναζητώντας έναν θησαυρό και ανακαλύπτει τη γλώσσα του κόσμου. Το αγαπημένο μυθιστόρημα εκατομμυρίων.",
    coverColor: "bg-yellow-100",
    ageGroup: "erwachsene"
    },
    {
    id: 107,
    title: "Το Ημερολόγιο της Άννας Φρανκ",
    author: "Άννα Φρανκ",
    isbn: "9789601421599",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601421599-L.jpg",
    pageCount: 288,
    publishYear: 2000,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["historisch", "literatur", "persoenliche_entwicklung"],
    difficulty: "einsteiger",
    timeEffort: "mittel",
    style: ["story", "reflektierend"],
    description: "Το συγκλονιστικό ημερολόγιο της νεαρής Εβραίας Άννας Φρανκ κατά τον Β΄ Παγκόσμιο Πόλεμο.",
    coverColor: "bg-stone-100",
    ageGroup: "erwachsene"
    },
    {
    ...
    author: "Σουν Τζου",
    isbn: "9789602430262",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789602430262-L.jpg",
    pageCount: 128,
    publishYear: 2001,
    publisher: "Κάκτος",
    language: "el",
    tags: ["fokus_produktivitaet", "persoenliche_entwicklung", "lernen_wissen"],
    difficulty: "einsteiger",
    timeEffort: "kurz",
    style: ["praktisch", "kurz"],
    description: "Οι αρχαίες αρχές στρατηγικής του Σουν Τζου εφαρμοσμένες στη σύγχρονη ζωή.",
    coverColor: "bg-red-100",
    ageGroup: "erwachsene"
    },
    {
    id: 109,
    title: "Μικρός Πρίγκιπας",
    author: "Antoine de Saint-Exupéry",
    isbn: "9789601418124",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601418124-L.jpg",
    pageCount: 112,
    publishYear: 1998,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["freundschaft", "sinn_philosophie", "literatur"],
    difficulty: "einsteiger",
    timeEffort: "kurz",
    style: ["story", "reflektierend"],
    description: "Η αγαπημένη ιστορία για φιλία, αγάπη και τα μυστικά που βλέπουμε μόνο με την καρδιά.",
    coverColor: "bg-yellow-100",
    ageGroup: "erwachsene"
    },
    {
    ...
    author: "Umberto Eco",
    isbn: "9789600302639",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789600302639-L.jpg",
    pageCount: 560,
    publishYear: 2000,
    publisher: "Καζαντζάκης",
    language: "el",
    tags: ["thriller_krimi", "historisch", "literatur"],
    difficulty: "erfahren",
    timeEffort: "lang",
    style: ["story", "anspruchsvoll"],
    description: "Ένα μεσαιωνικό αστυνομικό θρίλερ με φιλοσοφικό βάθος. Αριστούργημα της παγκόσμιας λογοτεχνίας.",
    coverColor: "bg-stone-100",
    ageGroup: "erwachsene"
    },
    {
    id: 111,
    title: "Χαρή Πότερ και η Φιλοσοφική Λίθος",
    author: "J.K. Rowling",
    isbn: "9789601602127",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601602127-L.jpg",
    pageCount: 320,
    publishYear: 2001,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["fantasy_scifi", "abenteuer", "freundschaft"],
    difficulty: "einsteiger",
    timeEffort: "mittel",
    style: ["story"],
    description: "Ο Χάρι ανακαλύπτει ότι είναι μάγος και πηγαίνει στο Χόγκουαρτς. Η αρχή της μεγάλης σειράς.",
    coverColor: "bg-purple-100",
    ageGroup: "erwachsene"
    },
    {
    id: 112,
    title: "Ο Άρχοντας των Δαχτυλιδιών",
    author: "J.R.R. Tolkien",
    isbn: "9789601601533",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601601533-L.jpg",
    pageCount: 600,
    publishYear: 2002,
    publisher: "Ψυχογιός",
    language: "el",
    ...
    timeEffort: "lang",
    style: ["story", "anspruchsvoll"],
    description: "Το επικό φανταστικό αριστούργημα του Tolkien στα ελληνικά.",
    coverColor: "bg-green-100",
    ageGroup: "erwachsene"
    },
    {
    id: 113,
    title: "Πεθαίνοντας να Ζήσεις",
    author: "Μάνος Κοντολέων",
    isbn: "9789604560240",
    pageCount: 240,
    publishYear: 2010,
    publisher: "Πατάκης",
    language: "el",
    tags: ["literatur", "sinn_philosophie", "persoenliche_entwicklung"],
    difficulty: "einsteiger",
    timeEffort: "mittel",
    style: ["story", "reflektierend"],
    description: "Σύγχρονο ελληνικό μυθιστόρημα για αγάπη, απώλεια και την ανακάλυψη του εαυτού.",
    coverColor: "bg-rose-100",
    ageGroup: "erwachsene"
    },
    {
    id: 114,
    title: "Η Αθάνατη Ζωή της Henrietta Lacks",
    ...
    publisher: "Πατάκης",
    language: "el",
    tags: ["lernen_wissen", "historisch"],
    difficulty: "fortgeschritten",
    timeEffort: "mittel",
    style: ["story", "wissenschaftlich"],
    description: "Η αληθινή ιστορία της γυναίκας που τα κύτταρά της έσωσαν εκατομμύρια ζωές.",
    coverColor: "bg-teal-100",
    ageGroup: "erwachsene"
    },
    {
    id: 115,
    title: "Η Ζωή μπροστά μου",
    author: "Ρομέν Γκαρί",
    isbn: "9789601418018",
    pageCount: 272,
    publishYear: 1996,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["literatur", "drama"],
    difficulty: "fortgeschritten",
    timeEffort: "mittel",
    style: ["story", "reflektierend"],
    description: "Το βραβευμένο με Goncourt μυθιστόρημα για τη σχέση ενός μικρού παιδιού και μιας γηρασμένης γυναίκας.",
    coverColor: "bg-orange-100",
    ageGroup: "erwachsene"
    },
    ...
    author: "Antoine de Saint-Exupéry",
    isbn: "9789601418117",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601418117-L.jpg",
    pageCount: 112,
    publishYear: 1996,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["freundschaft", "sinn_philosophie", "philosophie"],
    difficulty: "einsteiger",
    timeEffort: "kurz",
    style: ["story", "reflektierend"],
    description: "Η διαχρονική ιστορία για φιλία και αγάπη που αγαπούν παιδιά και μεγάλοι.",
    coverColor: "bg-yellow-100",
    ageGroup: "kinder"
    },
    {
    id: 122,
    title: "Χάρι Πότερ και η Φιλοσοφική Λίθος",
    author: "J.K. Rowling",
    isbn: "9789601602110",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601602110-L.jpg",
    pageCount: 320,
    publishYear: 2000,
    publisher: "Ψυχογιός",
    language: "el",
    ...
    timeEffort: "mittel",
    style: ["story"],
    description: "Ο Χάρι ανακαλύπτει ότι είναι μάγος. Για παιδιά που αγαπούν τη φαντασία και την περιπέτεια.",
    coverColor: "bg-purple-100",
    ageGroup: "kinder"
    },
    {
    ...
    author: "Roald Dahl",
    isbn: "9789604560011",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789604560011-L.jpg",
    pageCount: 240,
    publishYear: 2008,
    publisher: "Πατάκης",
    language: "el",
    ...
    timeEffort: "kurz",
    style: ["story"],
    description: "Η Ματίλντα είναι ένα εξαιρετικά έξυπνο κορίτσι με μαγικές δυνάμεις. Αγαπημένο παιδικό βιβλίο.",
    coverColor: "bg-blue-100",
    ageGroup: "kinder"
    },
    {
    id: 124,
    title: "Το Τερατώδες Τέρας",
    author: "Κόνορ Ντόνελι (Patrick Ness)",
    isbn: "9789604563012",
    pageCount: 216,
    publishYear: 2013,
    publisher: "Πατάκης",
    language: "el",
    tags: ["abenteuer", "mut", "freundschaft"],
    difficulty: "einsteiger",
    timeEffort: "kurz",
    style: ["story", "reflektierend"],
    description: "Ένα παιδί αντιμετωπίζει ένα τέρας που εμφανίζεται στα μεσάνυχτα. Συγκινητικό και τρυφερό βιβλίο.",
    coverColor: "bg-green-100",
    ageGroup: "kinder"
    },
    {
    ...
    author: "J.R.R. Tolkien",
    isbn: "9789601601762",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601601762-L.jpg",
    pageCount: 310,
    publishYear: 2001,
    publisher: "Ψυχογιός",
    language: "el",
    ...
    timeEffort: "mittel",
    style: ["story"],
    description: "Ο Μπίλμπο Μπάγκινς ξεκινά ένα απρόσμενο ταξίδι με νάνους και έναν μάγο. Για παιδιά που λατρεύουν την περιπέτεια.",
    coverColor: "bg-teal-100",
    ageGroup: "kinder"
    },
    ...
    isbn: "9789604562572",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789604562572-L.jpg",
    pageCount: 488,
    publishYear: 2012,
    publisher: "Πατάκης",
    language: "el",
    tags: ["abenteuer", "mut", "selbstfindung"],
    difficulty: "einsteiger",
    timeEffort: "mittel",
    style: ["story"],
    description: "Σε μια μελλοντική κοινωνία όπου οι άνθρωποι χωρίζονται σε φατρίες, η Τρις αρνείται να ανήκει σε μία μόνο.",
    coverColor: "bg-slate-100",
    ageGroup: "jugendliche"
    },
    {
    id: 132,
    title: "Τα Παιχνίδια της Πείνας",
    author: "Suzanne Collins",
    isbn: "9789604561964",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789604561964-L.jpg",
    pageCount: 400,
    publishYear: 2010,
    publisher: "Πατάκης",
    language: "el",
    ...
    timeEffort: "mittel",
    style: ["story"],
    description: "Η Κάτνις Έβερντιν αγωνίζεται για την επιβίωσή της σε ένα σκληρό διαγωνισμό. Η ελληνική μετάφραση του Hunger Games.",
    coverColor: "bg-red-100",
    ageGroup: "jugendliche"
    },
    {
    ...
    author: "Άννα Φρανκ",
    isbn: "9789601421605",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601421605-L.jpg",
    pageCount: 288,
    publishYear: 2001,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["historisch", "selbstfindung", "gesellschaft"],
    difficulty: "einsteiger",
    timeEffort: "mittel",
    style: ["story", "reflektierend"],
    description: "Το συγκλονιστικό ημερολόγιο μιας νεαρής Εβραίας κατά τον Β΄ Παγκόσμιο Πόλεμο.",
    coverColor: "bg-stone-100",
    ageGroup: "jugendliche"
    },
    {
    ...
    author: "Paulo Coelho",
    isbn: "9789601408040",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789601408040-L.jpg",
    pageCount: 192,
    publishYear: 1999,
    publisher: "Ψυχογιός",
    language: "el",
    tags: ["sinn_philosophie", "selbstfindung", "abenteuer"],
    difficulty: "einsteiger",
    timeEffort: "kurz",
    style: ["story", "reflektierend"],
    description: "Ένα αγόρι ακολουθεί το όνειρό του. Εμπνευσμένο μυθιστόρημα για εφήβους που αναζητούν τον δρόμο τους.",
    coverColor: "bg-yellow-100",
    ageGroup: "jugendliche"
    },
    {
    id: 135,
    title: "Ο Κλέφτης Βιβλίων",
    author: "Markus Zusak",
    isbn: "9789604562602",
    coverUrl: "https://covers.openlibrary.org/b/isbn/9789604562602-L.jpg",
    pageCount: 560,
    publishYear: 2012,
    publisher: "Πατάκης",
    language: "el",
    tags: ["historisch", "literatur", "freundschaft"],
    difficulty: "fortgeschritten",
    timeEffort: "lang",
    style: ["story", "anspruchsvoll"],
    description: "Η Λίζελ Μέμιγκερ κλέβει βιβλία στη ναζιστική Γερμανία. Αφηγητής ο ίδιος ο Χάρος.",
    coverColor: "bg-indigo-100",
    ageGroup: "jugendliche"
    }
    ];
