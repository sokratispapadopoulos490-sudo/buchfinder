...
const dict = {
  ...
  'profile.usernameInvalid': {
    de: 'Nur Kleinbuchstaben, Zahlen und _ erlaubt (2–30 Zeichen).',
    en: 'Only lowercase letters, numbers and _ allowed (2–30 chars).',
    el: 'Μόνο πεζά γράμματα, αριθμοί και _ (2–30 χαρακτήρες).',
    tr: 'Sadece küçük harf, rakam ve _ kullanılabilir (2–30 karakter).',
    fr: 'Uniquement minuscules, chiffres et _ (2–30 caractères).',
    es: 'Solo minúsculas, números y _ (2–30 caracteres).',
    it: 'Solo minuscole, numeri e _ (2–30 caratteri).',
  },
  'profile.usernameTaken': {
    de: 'Dieser Username ist bereits vergeben. Bitte wähle einen anderen.',
    en: 'This username is already taken. Please choose another.',
    el: 'Αυτό το username χρησιμοποιείται ήδη. Παρακαλώ επίλεξε άλλο.',
    ...
    it: 'Questo nome utente è già in uso. Scegli un altro.',
  },
  'profile.usernamePublicRequired': {
    de: 'Ein öffentliches Profil benötigt einen Username, damit andere dich finden können.',
    en: 'A public profile requires a username so others can find you.',
    el: 'Ένα δημόσιο προφίλ απαιτεί username ώστε άλλοι να μπορούν να σε βρουν.',
    tr: 'Herkese açık bir profil, başkalarının seni bulabilmesi için kullanıcı adı gerektirir.',
    fr: 'Un profil public nécessite un nom d\'utilisateur pour que les autres puissent vous trouver.',
    es: 'Un perfil público requiere un nombre de usuario para que otros puedan encontrarte.',
    it: 'Un profilo pubblico richiede un nome utente affinché gli altri possano trovarti.',
  },
  'profile.bio': {
